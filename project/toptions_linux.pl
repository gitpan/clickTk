...
##
my $mw = $self;
## ctk: code generated by ctk_w version ''
...
$wr_017 = $wr_002 -> Entry ( -state , 'normal' , -width , 64 , -justify , 'left' , -relief , 'sunken' , -textvariable , \$server  ) -> grid(-row=>0, -sticky=>'ne', -column=>1);


$wr_018 = $wr_002 -> Label ( -relief , 'flat' , -justify , 'left' , -text , 'Priority'  ) -> grid(-row=>1, -column=>0, -sticky=>'ne');


$wr_019 = $wr_002 -> BrowseEntry ( -background , '#ffffff' , -width , 20 , -justify , 'left' , -relief , 'sunken'  ) -> grid(-row=>1, -sticky=>'nw', -column=>1);
...
$wr_034 = $wr_002 -> BrowseEntry ( -background , '#ffffff' , -width , 20 , -justify , 'left' , -relief , 'sunken'  ) -> grid(-row=>2, -sticky=>'nw', -column=>1);
...
&main::init();
my (%args) =();
my $instance = $mw->toptions_linux(%args)->pack();
